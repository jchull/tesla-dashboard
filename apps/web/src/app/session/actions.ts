import { VehicleActivity, VehicleState } from '@tesla-dashboard/types';
...
export interface SessionState {
  sessions: VehicleActivity[];
  selectedSessionId?: string;
  selectedSessionStates?: VehicleState[];
...
export enum SessionActionType {
  FETCH_SESSION_LIST__CLEAR = 'FETCH_SESSION_LIST__CLEAR',
...
export const fetchSessionListClear = createAction(SessionActionType.FETCH_SESSION_LIST__CLEAR);

export const fetchSessionListPage = createAction(SessionActionType.FETCH_SESSION_PAGE__START);

export const fetchSessionListFail = createAction(SessionActionType.FETCH_SESSION_LIST__FAIL, (error: any) => ({
  payload: error,
}));
...
export const updateFilters = createAction(SessionActionType.UPDATE_FILTERS, (filters: any) => ({
  payload: {
    //TODO: updateAccount filters in store, then requery
  },
}));

export const fetchAllTagsStart = createAction(SessionActionType.FETCH_ALL_TAGS__START);

export const fetchAllTagsSuccess = createAction(SessionActionType.FETCH_ALL_TAGS__SUCCESS, (tags) => ({
  payload: {
    availableTags: tags,
  },
}));

export const fetchAllTagsFail = createAction(SessionActionType.FETCH_ALL_TAGS__FAIL);
...
export const removeSessionTagAction = (sessionId: string, tag: string) => async (
  dispatch: any,
  getState: any,
  extraArgument: { api: ApiType }
): Promise<any> => {
