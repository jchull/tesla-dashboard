...
export const AccountComponent: FC = () => {
  ...
  useEffect(() => {
    ...
    const pv =
      (formData.password1 && formData.password1.length > 9 && formData.password1 === formData.password2) || false;
    // check form valid
  ...
  return (
    <div className="centered narrow">
      ...
      <form onSubmit={handleSubmit}>
        <input placeholder="Username" name="username" type="text" value={formData.username} onChange={handleChange} />
