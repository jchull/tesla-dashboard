import { TagList } from '@tesla-dashboard/components';
import React from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { AppState } from '../store';
import { createSelector } from '@reduxjs/toolkit';
import { addSessionTagAction, removeSessionTagAction } from '../session/actions';
...
export const SessionTagList: React.FC = () => {
  ...
  const tagsSelector = createSelector([sessionsSelector, sessionIdSelector], (sessions, selectedSessionId) => {
  ...
  return <TagList tags={tags} removeListener={removeListener} addListener={addListener} />;
};
